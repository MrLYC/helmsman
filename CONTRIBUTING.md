...
The following is a set of guidelines for contributing to Helmsman. These are
...
We use GitHub issues to track public bugs/enhancements. Report a new one by [opening a new issue](https://github.com/mrlyc/helmsman/issues).
